...
import com.ganesha.minimarket.facade.SaleSummaryReportFacade;
import com.ganesha.minimarket.utils.PermissionConstants;

public class SaleSummaryReportListDialog extends XJTableDialog {
	...
	public SaleSummaryReportListDialog(Window parent) {
		super(parent);
		getContentPane().setLayout(
				new MigLayout("", "[grow]", "[][300,grow][]"));

		setTitle("Laporan Ringkasan Penjualan");
		setPermissionCode(PermissionConstants.REPORT_SALESUMMARY_LIST);
			...
			public void rowSelected() {
				try {
					...
					ExceptionHandler.handleException(
							SaleSummaryReportListDialog.this, ex);
				}
			}
		};
	...
	public void loadData() throws AppException, UserException {
		...
		try {
			...
			List<Map<String, Object>> searchResults = SaleSummaryReportFacade
