...
public class SaleReturnInquiryFacade implements TransactionInquiryFacade {

	private static SaleReturnInquiryFacade instance;

	public static SaleReturnInquiryFacade getInstance() {
		if (instance == null) {
			instance = new SaleReturnInquiryFacade();
		}
		return instance;
	}

	private SaleReturnInquiryFacade() {
	}
