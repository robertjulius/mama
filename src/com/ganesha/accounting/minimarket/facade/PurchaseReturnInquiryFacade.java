...
public class PurchaseReturnInquiryFacade implements TransactionInquiryFacade {

	private static PurchaseReturnInquiryFacade instance;

	public static PurchaseReturnInquiryFacade getInstance() {
		if (instance == null) {
			instance = new PurchaseReturnInquiryFacade();
		}
		return instance;
	}

	private PurchaseReturnInquiryFacade() {
	}
